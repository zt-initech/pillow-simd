...
class TestImageEntropy(PillowTestCase):
    def test_entropy(self):
        ...
        self.assertAlmostEqual(entropy("L"), 7.06650513081286, places=3)
        self.assertAlmostEqual(entropy("I"), 7.06650513081286, places=3)
        self.assertAlmostEqual(entropy("F"), 7.06650513081286, places=3)
